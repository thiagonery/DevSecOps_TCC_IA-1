...
export const PlanScreen: React.FC = () => {
  ...
  return (
    <SkeletonLayout
      drawerFocus="plan"
      title="Etapa - PLAN"
      subtitle="Nesta parte do ciclo de DevSecOps, iremos fornecer algumas sugestões de planejamento, pensando em segurança da informação, utilizando a linguagem de programação e o banco de dados do seu projeto."
